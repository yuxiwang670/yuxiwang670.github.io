...
I am **Yuxi Wang (王愉茜)**, a **Ph.D. candidate in Applied Psychology** at **Peking University**. My research interests include **computational cognitive science**, **social cognition**, **prior expectation**, **brain imaging**, and **neuroscience**.

My work explores the cognitive and neural mechanisms underlying altered social cognition in clinical populations. I use computational modeling and brain imaging to study social information processing, with a current focus on how prior expectations shape cognition and behavior.
